...
def test_home():
    testing = urllib.request.urlopen(serviceUrl + '/service01')
    output = testing.getcode()
    assert 200 == output

def test_getUsers():
    testing = urllib.request.urlopen(serviceUrl + '/service01/users')
...
def test_get_user_profile():
    ...
    testing = urllib.request.urlopen(serviceUrl + '/service01/users/'+userid)
    output = testing.read().decode('utf-8')
...
def test_get_history():
    ...
    while(not found):
        ...
        testing = urllib.request.urlopen(serviceUrl + '/service01/users/'+userid+'/songs')
        output = testing.read().decode('utf-8')
        if(len(output) > 8):
            found=True
        else:
...
def test_get_search_history():
    ...
    while(not found):
        ...
        testing = urllib.request.urlopen(serviceUrl + '/service01/users/'+userid+'/searches')
        output = testing.read().decode('utf-8')
        if(len(output) > 8):
            found=True
        else:
...
def test_amount_song_played_by_user():
    testing = urllib.request.urlopen(serviceUrl + '/service01/users/'+globaluserid+'/songs')
    ...
    testing = urllib.request.urlopen(serviceUrl + '/service01/users/'+globaluserid+'/songs/'+songname+'/amount_played')
    output = testing.read().decode('utf-8')
...
def test_amount_artist_played_by_user():
    ...
    testing = urllib.request.urlopen(serviceUrl + '/service01//users/'+globaluserid+'/artists/'+artistname+'/amount_played')
    output = testing.read().decode('utf-8')
    
    assert "plays" in output

def test_amount_song_played():
    testing = urllib.request.urlopen(serviceUrl + '/service01/songs/'+globalsong+'/amount_played')
    output = testing.read().decode('utf-8')
    assert "plays" in output

def test_artist_amount_played():
    testing = urllib.request.urlopen(serviceUrl + '/service01/artists/'+globalartist+'/amount_played')
    output = testing.read().decode('utf-8')
    assert "plays" in output


def test_ad_amount_clicked():#/ads/<id>/amount_clicked
    testing = urllib.request.urlopen(serviceUrl + '/service01/ads')
    output = testing.read().decode('utf-8')
    ...
    testing = urllib.request.urlopen(serviceUrl + '/service01/ads/'+adid+'/amount_clicked')
    output = testing.read().decode('utf-8')
...
def test_get_top_songs():
    testing = urllib.request.urlopen(serviceUrl + '/service01/songs/top')
    output = testing.read().decode('utf-8')
    assert "plays" in output
    assert "song" in output

def test_get_top_artists():
    testing = urllib.request.urlopen(serviceUrl + '/service01/artists/top')
    output = testing.read().decode('utf-8')
    assert "artist" in output
    assert "plays" in output

def test_get_top_artist_for_user():
    testing = urllib.request.urlopen(serviceUrl + '/service01/users/' +globaluserid+ '/artists/top')
    output = testing.read().decode('utf-8')
    assert "artist" in output
    assert "plays" in output

def test_get_top_songs_for_user():
    testing = urllib.request.urlopen(serviceUrl + '/service01/users/' +globaluserid+ '/songs/top')
    output = testing.read().decode('utf-8')
    assert "song" in output
    assert "plays" in output

def test_get_top_genres_for_user():
    testing = urllib.request.urlopen(serviceUrl + '/service01/users/' +globaluserid+ '/genres/top')
    output = testing.read().decode('utf-8')
    assert "genre" in output
    assert "plays" in output

def test_get_namespace_log():
    testing05 = urllib.request.urlopen(serviceUrl + '/service01/logs/team05')
    testingkube = urllib.request.urlopen(serviceUrl + '/service01/logs/kube-system')
    testinglonghorn = urllib.request.urlopen(serviceUrl + '/service01/logs/longhorn')
    testingfluent = urllib.request.urlopen(serviceUrl + '/service01/logs/fluent')
    testingingress = urllib.request.urlopen(serviceUrl + '/service01/logs/ingress-nginx')
...
def test_get_genres_recommendation_for_user():
    testing = urllib.request.urlopen(serviceUrl + '/service01/users/' +globaluserid+ '/recommendation/songs')
    output = testing.read().decode('utf-8')
    assert "title" in output
    assert "genre" in output
    assert "artist" in output
...
def test_get_artist_recommendation_for_user():#/users/<id>/recommendation/artists
    testing = urllib.request.urlopen(serviceUrl + '/service01/users/' +globaluserid+ '/recommendation/artists')
    output = testing.read().decode('utf-8')
...
def test_get_multiple_song_matches():
    testing = urllib.request.urlopen(serviceUrl + '/service01/users/' +globaluserid+ '/comparativerec/songs')
    output = testing.read().decode('utf-8')
    assert "Title" in output
